...
class Base:
    ...
    MAIL_USE_TLS  = True
    MAIL_USERNAME = os.environ.get("MAIL_USERNAME")   # set in shell / CI
    MAIL_PASSWORD = os.environ.get("MAIL_PASSWORD")   # set in shell / CI
    MAIL_DEFAULT_SENDER = ("Elite Dating Search", MAIL_USERNAME)
